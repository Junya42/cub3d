...
/*   Updated: 2022/06/13 19:39:08 by anremiki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_animation_light_red(t_sp *s)
{
	...
	i = -1;
	s->anim_paths[0] = "./bonus/imgs/s_red/red0.xpm";
	s->anim_paths[1] = "./bonus/imgs/s_red/red1.xpm";
	s->anim_paths[2] = "./bonus/imgs/s_red/red2.xpm";
	s->anim_paths[3] = "./bonus/imgs/s_red/red3.xpm";
	s->anim_paths[4] = "./bonus/imgs/s_red/red4.xpm";
	s->anim_paths[5] = "./bonus/imgs/s_red/red5.xpm";
	s->anim_paths[6] = "./bonus/imgs/s_red/red6.xpm";
	s->anim_paths[7] = "./bonus/imgs/s_red/red7.xpm";
	while (++i < 8)
...
int	txt_light_red(t_sp *sp, t_cub *cub)
{
	...
	if (init_animation(sp, cub, 1) == 0)
		return (0);
	sp->img = mlx_xpm_file_to_image(cub->mlx, "./bonus/imgs/s_red/red0.xpm",
			&sp->a, &sp->b);
	if (!sp->img)
		return (0);
	sp->csp.moveable = 1;
