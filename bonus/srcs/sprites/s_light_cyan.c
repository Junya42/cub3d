...
/*   Updated: 2022/06/13 19:37:21 by anremiki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_animation_light_cyan(t_sp *s)
{
	...
	i = -1;
	s->anim_paths[0] = "./bonus/imgs/s_cyan/cyan0.xpm";
	s->anim_paths[1] = "./bonus/imgs/s_cyan/cyan1.xpm";
	s->anim_paths[2] = "./bonus/imgs/s_cyan/cyan2.xpm";
	s->anim_paths[3] = "./bonus/imgs/s_cyan/cyan3.xpm";
	s->anim_paths[4] = "./bonus/imgs/s_cyan/cyan4.xpm";
	s->anim_paths[5] = "./bonus/imgs/s_cyan/cyan5.xpm";
	s->anim_paths[6] = "./bonus/imgs/s_cyan/cyan6.xpm";
	s->anim_paths[7] = "./bonus/imgs/s_cyan/cyan7.xpm";
	while (++i < 8)
...
int	txt_light_cyan(t_sp *sp, t_cub *cub)
{
	...
	if (init_animation(sp, cub, 1) == 0)
		return (0);
	sp->img = mlx_xpm_file_to_image(cub->mlx, "./bonus/imgs/s_cyan/cyan0.xpm",
			&sp->a, &sp->b);
	if (!sp->img)
		return (0);
	sp->csp.moveable = 1;
